    ...
    >
      <div className="text-center text-[#3B3030]">
        ...
        <p className="text-lg mb-8 max-w-[900px] animate-fade-in delay-200">
          ...
          atque quis asperiores? Obcaecati sapiente unde minus? Porro, blanditiis
          officiis ipsam reprehenderit provident quibusdam amet. Quisquam
          perferendis voluptatibus eum id.
        </p>
